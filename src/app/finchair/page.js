  ...
  return (
    <>
      <main className={styles.main}>
        <ProjectHeader projectName={"FinChair"} projectDescription={"A credit score motivation app. Increase your score and win rewards."}  imageSource={"/images/finchair/header-img-both.png"} imageAlt={"Two Finchair app screens. Bills screen and rewards screen."} imageWidth={5000} imageHeight={5945} priority/>
        <OverviewSection
        ...
        <div className={styles.mainProject}>
          ...
          <ImageSection imgTitle={"UI designs the client provided (version 1.0)"} imageSource={"/images/finchair/client.png"} imageAlt={"Finchair original UI designs provided by client"} imageWidth={3626} imageHeight={1751} imgDescription={"The original design had some accessibility issues, including not meeting contrast guidelines. It also lacked a clear user journey and visual hierarchy with the pages looking fairly similar. The designs helped us see what information and layout users would need/expect within the app. "}/>
          ...
          <Image className={styles.onlyImg} src="/images/finchair/moodboard.png" alt="Mood board for FinChair design" width={5105} height={3778}/>
          ...
          <ImageSection imageSource={"/images/finchair/fc-initial-designs.png"} imageAlt={"First designs for the finchair app"} imageWidth={7400} imageHeight={3508}/>  
          ...
          <ImageSection imgTitle={"Iterations: Homepage & Rewards Page"} imageSource={"/images/finchair/fc-design-iterations.png"} imageAlt={"Four screens of the finchair app designs in early stages"} imageWidth={3626} imageHeight={1751} imgDescription={"A glimpse into the early stages of our design iterations and how we could optimally display the information to users. We played around with a few different card options and homepage display as this is where users would be drawn in."}/>
          ...
          <div className={styles.finalSection}>
            <Image className={styles.onlyImg} src="/images/finchair/fc-homepages.png" alt="Five homepage screenshots of the finchair app final designs" width={6000} height={3500}/> 
            <Image className={styles.onlyImg} src="/images/finchair/3-iphone-blue.png" alt="Three screenshots of the finchair app final designs, the wallet, bills and rewards pages" width={4500} height={2800}/>
            <Image className={styles.onlyImg} src="/images/finchair/finchair-3-rewards.png" alt="Three screenshots of the finchair app rewards function final designs" width={4500} height={2800}/>
          </div>  
          <ReviewSection 
            textOne={(
              <>
