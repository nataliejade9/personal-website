    ...
    <>
      <main className={styles.main}>
        ...
        <div className={styles.mainProject}>
          ...
          <ImageSection imgTitle={"UI designs the client provided (version 1.0)"} imageSource={"/images/finchair/Client-designs.png"} imageAlt={"Finchair original UI designs provided by client"} imageWidth={3626} imageHeight={1751} imgDescription={"The original design had some accessibility issues, including not meeting contrast guidelines. It also lacked a clear user journey and visual hierarchy with the pages looking fairly similar. The designs helped us see what information and layout users would need/expect within the app. "}/>
          ...
          <Image className={styles.onlyImg} src="/images/finchair/Moodboard-finchair.png" alt="Mood board for FinChair design" width={5105} height={3778}/>
