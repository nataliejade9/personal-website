  ...
  return (
    <>
      <main className={styles.main}>
        <ProjectHeader projectName={"FinChair"} projectDescription={"A credit score motivation app. Increase your score and win rewards."}  imageSource={"/images/finchair/header-img-both.png"} imageAlt={"Two Finchair app screens. Bills screen and rewards screen."} imageWidth={778} imageHeight={851} priority/>
        <OverviewSection
        ...
        <div className={styles.mainProject}>
          <Image className={styles.onlyImg} src="/images/finchair/finchair-screens.jpg" alt="Ten iphone screens showing different pages of the FinChair app" width={1920} height={981}/>
          ...
          <ImageSection imgTitle={"UI designs the client provided (version 1.0)"} imageSource={"/images/finchair/client.png"} imageAlt={"Finchair original UI designs provided by client"} imageWidth={1472} imageHeight={711} imgDescription={"The original design had some accessibility issues, including not meeting contrast guidelines. It also lacked a clear user journey and visual hierarchy with the pages looking fairly similar. The designs helped us see what information and layout users would need/expect within the app. "}/>
          ...
          <Image className={styles.onlyImg} src="/images/finchair/moodboard.png" alt="Mood board for FinChair design" width={1920} height={1090}/>
          ...
          <ImageSection imageSource={"/images/finchair/fc-initial-designs.png"} imageAlt={"First designs for the finchair app"} imageWidth={1472} imageHeight={698}/>  
          ...
          <ImageSection imgTitle={"Iterations: Homepage & Rewards Page"} imageSource={"/images/finchair/fc-design-iterations.png"} imageAlt={"Four screens of the finchair app designs in early stages"} imageWidth={1472} imageHeight={698} imgDescription={"A glimpse into the early stages of our design iterations and how we could optimally display the information to users. We played around with a few different card options and homepage display as this is where users would be drawn in."}/>
          <TitleSection title={"Final Designs"} information={"After making any last design edits we presented the final designs and prototype to the client. We had some very positive feedback from the client. In particular they loved the abstract space theme and thought it put across a sophisticated aesthetic. He also really enjoyed the gamification of the rewards section, as he had a few designers look at this project and found this to be unique and stand out for the brand. Encouraging more investment and user adoption in the early stages."}/>
          <div className={styles.finalSection}>
            <Image className={styles.onlyImg} src="/images/finchair/fc-homepages.png" alt="Five homepage screenshots of the finchair app final designs" width={1920} height={859}/> 
            <Image className={styles.onlyImg} src="/images/finchair/3-iphone-blue.png" alt="Three screenshots of the finchair app final designs, the wallet, bills and rewards pages" width={1920} height={916}/>
            <Image className={styles.onlyImg} src="/images/finchair/finchair-3-rewards.png" alt="Three screenshots of the finchair app rewards function final designs" width={1920} height={916}/>
          </div>  
          <ReviewSection 
            textOne={(
              <>
