    ...
    <>
      <main className={styles.main}>
        ...
        <div className={styles.mainProject}>
          <Image className={styles.onlyImg} src="/images/housebrain/housebrain-full-set.png" alt="Seven iphone screens showing different pages of the HouseBrain app" width={1920} height={1141}/>
          ...
          <ImageSection imgTitle={"Competitor Analysis"} imageSource={"/images/housebrain/competitor-analysis.png"} imageAlt={"Competitor analysis for HouseBrain App"} imageWidth={1472} imageHeight={2138} sizes={"50vw"} quality={50}/>
