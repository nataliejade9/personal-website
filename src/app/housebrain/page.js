    ...
    <>
      <main className={styles.main}>
        ...
        <div className={styles.mainProject}>
          ...
          <Image className={styles.onlyImg} src="/images/housebrain/User-research-results.png" alt="Research results for survey conducted for HouseBrain App" width={14663} height={10802}/>
