    ...
    <main className={styles.main}>
      ...
      <OverviewSection
        ...
        <div className={styles.mainProject}>
          ...
          <TitleSection title={"User Interviews: understanding their experience"} information={"I was able to arrange a more in-depth interview three people who participated in the survey. This was super valuable to the project as not only did I receive more information on the problem and their solutions but I was able to listen to their experience and understand the bigger picture. It was important for me to empathise and understand the situation user's were in as best I could to build a product that would suit them."}/>
          ...
          <TitleSection title={"Defining user interview information"} information={""}/>
