    ...
    <main className={styles.main}>
      ...
      <OverviewSection
        ...
        <div className={styles.mainProject}>
          ...
          <TitleSection title={"Defining interview information"} information={"From the interviews I made an experience map to understand the problems faced by the user and where Umuntu could fit in that picture. Then, I used the affinity map, to pull out the key themes discussed and would later use these to form the How Might We statements."}/>
          <ImageSection imageSource={"/images/umuntu/Umuntu-experience-map.png"} imageAlt={"Experience map for users"} imageWidth={6976} imageHeight={4396} imgDescription={"Within this experience map we have identified where Umuntu could sit. Fulfilling users' needs, where they are currently underserved."}/>
          <Image className={styles.onlyImg} src="/images/umuntu/key-themes.png" alt="Key themes from the user interviews" width={2754} height={1552}/>

          <TitleSection title={"Design Ideation"} information={""}/>
          <ImageSection imageSource={"/images/umuntu/Umuntu-experience-map.png"} imageAlt={"Experience map for users"} imageWidth={6976} imageHeight={4396} imgDescription={"Within this experience map we have identified where Umuntu could sit. Fulfilling users' needs, where they are currently underserved."}/>
          <Image className={styles.onlyImg} src="/images/umuntu/key-themes.png" alt="Key themes from the user interviews" width={2754} height={1552}/>
