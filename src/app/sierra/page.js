...
export default function ProjectPage() {
  return (
    ...
    <main className={styles.main}>
      <ProjectHeader projectName={"Sierra"} projectDescription={"Jewellery store rebrand, giving users an easy and familiar way to shop their next purchase."}  imageSource={"/images/sierra/sierra-header-thin.png"} imageAlt={"Laptop and mobile screenshot of the Sierra Jewellery website"} imageWidth={4500} imageHeight={3000} priority/>
        <OverviewSection
        ...
        <div className={styles.mainProject}>
          <Image className={styles.onlyImg} src="/images/sierra/sierra-hero-img.png" alt="Homepage of Sierra Jewellery website on mac and mobile mock ups" width={2796} height={1820}/>
          ...
          <ImageSection imgTitle={"Understanding the business: Lean Canvas"} imageSource={"/images/sierra/sierra-lean-canvas.png"} imageAlt={"Filled out lean canvas for Sierra Jewellery"} imageWidth={3833} imageHeight={2359}/>
          <ImageSection imgTitle={"How can I help?: Agreeing the deliverables brainstorm"} imageSource={"/images/sierra/deliverables.png"} imageAlt={"Brainstorm of deciding deliverables"} imageWidth={3833} imageHeight={2359} imgDescription={"We agreed on a new brand identity (including style guide and design system), responsive e-commerce landing page with components to design future pages and packaging design."}/>
          ...
          <Image className={styles.onlyImg} src="/images/sierra/moodboard-sierra-j.png" alt="Mood board for Sierra Jewellery" width={2127} height={1762}/>
          ...
          <div className={styles.branding}>
            ...
            <Image className={styles.onlyImg} src="/images/sierra/sierra-colours.png" alt="Colour swatches for Sierra Jewellery designs" width={2973} height={1809}/>
            </div>
            <div className={styles.branding}>
              <div className={styles.textBranding}>
                <h2>Typography</h2>
            ...
            <Image className={styles.onlyImg} src="/images/sierra/sierra-typography.png" alt="Typography sets for Sierra Jewellery designs" width={3082} height={2447}/>
            </div>
            <div className={styles.branding}>
              <div className={styles.textBranding}>
                <h2>Logo Set</h2>
              ...
              <div className={styles.logos}>
                <Image className={styles.onlyImg} src="/images/sierra/sierra-logos.png" alt="Logo set for Sierra Jewellery design" width={1387} height={2632}/>
              </div>
            <div className={styles.mockups}>
              <Image className={styles.onlyImg} src="/images/sierra/necklace-ring-box.png" alt="Logo placement mock up on necklace jewellery box" width={4500} height={3000}/>
              ...
              <Image className={styles.onlyImg} src="/images/sierra/ring-box-mockup.png" alt="Jewellery box mock up with Sierra Logo" width={2913} height={1802}/>
            </div>
          </div>
          ...
          <ImageSection imageSource={"/images/sierra/sierra-design-edits.png"} imageAlt={"Initial Sierra Jewellery website designs and edit notes"} imageWidth={1512} imageHeight={3742} imgDescription={"There were multiple versions of the design. I'm a fan of testing throughout the design process and getting feedback on certain elements of the design to allow natural pivots towards a more user-friendly experience."}/>
          ...
          <div className={styles.finalSection}>
            <Image className={styles.onlyImg} src="/images/sierra/sierra-responsive-img.png" alt="Sierra homepage laptop and iPhone mockup" width={4500} height={3000}/> 
            <Image className={styles.onlyImg} src="/images/sierra/sierra-mood-img.png" alt="Sierra homepage laptop mockup" width={4500} height={3000}/> 
            <Image className={styles.onlyImg} src="/images/sierra/sierra-signup-img.png" alt="Sierra homepage laptop and iPhone mockup with book and reading glasses" width={4500} height={3000}/> 
            </div>  
          <ReviewSection 
            textOne={(
              <>
